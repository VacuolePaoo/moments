...
export function isValidDate(value: string): boolean {
  ...
  return Number.isFinite(instant.getTime()) && toShanghaiDate(instant.toISOString()) === value
}
...
export function mergePosts(current: MomentPost[], incoming: MomentPost[]): MomentPost[] {
